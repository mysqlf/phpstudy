        ...
        <div class="col-lg-5">
            <div class="ibox float-e-margins">
                <form method="post" action="<?php echo site_url('C_Website/drive_write/').$web_id.'/'.$m_id; ?>" class="form-horizontal">
                    ...
                    <?php if ($crm):?>
                        <p>对接crm</p>
                        <div class="form-group"><label class="col-lg-2 control-label">是否对接</label>
                            <input type="radio" name="crm" value="1">是
                            <input type="radio" name="crm" value="0" >否
                        </div>
                         <div class="form-group"><label class="col-lg-2 control-label">接口名称</label>
                        <div class="col-lg-10"><input type="text" value="" name="api_name"  class="form-control"></div>
                    </div>
                    <?php endif; ?>
