...
class WxPayConf_pub
{
	...
	const APPID = 'wx3bb26d7caff9e9ac';
	//受理商ID，身份标识
	const MCHID = '1245313002';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = '81E26B89581C4908B040FF6EAE7EC200';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = 'b4bd6a29f05cad95ecd956f30fbd8ebb';
	
	//=======【JSAPI路径设置】===================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	//const JS_API_CALL_URL = 'http://jiaz.hr5156.com/Wxpay/demo/js_api_call.php';
	//const JS_API_CALL_URL = 'http://jiaz.hr5156.com/Homemaking-wxpay';
	const JS_API_CALL_URL = 'http://jiaz.hr5156.com/Homemaking-wxpay';
	
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = '/Wxpay/WxPayPubHelper/cacert/apiclient_cert.pem';
	const SSLKEY_PATH = '/Wxpay/WxPayPubHelper/cacert/apiclient_key.pem';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	//const NOTIFY_URL = 'http://jiaz.hr5156.com/Wxpay/demo/notify_url.php';
	const NOTIFY_URL = 'http://jiaz.hr5156.com/Homemaking-wxpayNotify';
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function postXml()
	{
	    $xml = $this->createXml();//var_dump($this->url.$this->curl_timeout);
