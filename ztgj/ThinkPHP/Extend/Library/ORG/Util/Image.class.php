...
class Image {
     ...
     * @return string
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=32, $verifyName='verify') {
        import('ORG.Util.String');
        $font_file = THINK_PATH."/Common/simsun.ttf";
        $font_size = $height * 0.5; // 字体大小，为整个验证码高度的一半左右
        $randval = String::randString($length, $mode);
        $randval1 = strtolower($randval);
        session($verifyName, md5($randval1));
