 ...
 *
 */
var Zepto = require('../../lib/zepto/zepto.min');
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        function read() {
            ...
            var val = elm.data('initdate') || elm.val()  || '';
  
            that.temp = ((input && that.val !== null && that.val != elm.val()) || that.values === null) ? s.parseValue(val, that) : that.values.slice(0);
        ...
        that.init = function (ss) {
            ...
            if (s.display == 'inline') {
                ...
                if (input && s.showOnFocus) {
                    ...
                    e.readOnly = true;
                    // Init show datewheel
                    elm.bind(s.trigger+'.dw', function () { that.show(); });
                }
            }
        };
