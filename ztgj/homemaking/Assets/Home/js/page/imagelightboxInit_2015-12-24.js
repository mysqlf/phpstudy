				...
				var instanceE = selectorE.imageLightbox(
					{
						...
						onLoadEnd:	 function() { 
						navigationUpdate( selectorE ); activityIndicatorOff(); 
						
						var panup = new Hammer.Manager($('#imagelightbox')[0], {
						            threshold: 0
						        });
						panup.add( new Hammer.Tap({ event: 'dblTap', taps: 2}) );
						    panup.on('dblTap', function(ev) {
						    	$('#imagelightbox').addClass('imgScale')
							})
						}
					});
			});
