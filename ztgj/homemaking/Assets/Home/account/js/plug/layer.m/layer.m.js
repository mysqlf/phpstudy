...
path = path ? path : './js/plug/layer.m/';
...
Layer.prototype.view = function(){
    ...
    layerbox.setAttribute('class', classs[0] + ' ' + config.className + ' ' + classs[0]+(config.type || 0));
...
var layer = {
    ...
    close: function(index){
        var ibox = S('#'+classs[0]+index)[0],
            classN = ibox.className;
        if(!ibox) return;
        
        ibox.className = classN.replace('layermshow','');
        setTimeout(function(){
            ibox.innerHTML = '';
