...
class MenuAction extends Action {
    ...
    private function _menu()
    {
        ...
        */
        ...
        $tree['button'][0]['name'] ="找月嫂";
        $tree['button'][0]['sub_button'][0]['type'] = "view";
        $tree['button'][0]['sub_button'][0]['name'] = "我要预约";
        ...
        $tree['button'][0]['sub_button'][1]['type'] = "view";
        $tree['button'][0]['sub_button'][1]['name'] = "服务介绍";
        $tree['button'][0]['sub_button'][1]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-introduceYuesao&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][1]['name'] ="找育婴嫂";
        $tree['button'][1]['sub_button'][0]['type'] = "view";
        ...
        $tree['button'][0]['sub_button'][0]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-requirement-type-月嫂&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][0]['sub_button'][1]['type'] = "view";
        $tree['button'][0]['sub_button'][1]['name'] = "找育婴";
        ...
        /*第二栏*/
        $tree['button'][1]['name'] ="高端定制";
        $tree['button'][1]['sub_button'][0]['type'] = "view";
        $tree['button'][1]['sub_button'][0]['name'] = "定制月嫂";
        $redirect_url=urlencode(DOMAIN."Homemaking-index-t-customizeYuesao");
        $tree['button'][1]['sub_button'][0]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".$redirect_url."&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][1]['sub_button'][1]['type'] = "view";
        $tree['button'][1]['sub_button'][1]['name'] = "定制育婴师";
        $redirect_url=urlencode(DOMAIN."Homemaking-index-t-customizeYuyingshi");
        $tree['button'][1]['sub_button'][1]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".$redirect_url."&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][1]['sub_button'][2]['type'] = "view";
        $tree['button'][1]['sub_button'][2]['name'] = "定制粤管家";
        $redirect_url=urlencode(DOMAIN."Homemaking-index-t-customizeYueguanjia");
        $tree['button'][1]['sub_button'][2]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".$redirect_url."&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][1]['sub_button'][3]['type'] = "view";
        $tree['button'][1]['sub_button'][3]['name'] = "关于私享家";
        $redirect_url=urlencode(DOMAIN."Homemaking-index-t-customize");
        $tree['button'][1]['sub_button'][3]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".$redirect_url."&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        /*第三栏*/
        /*$tree['button'][2]['name'] ="妈妈帮";
        ...
        $tree['button'][2]['name'] ="领红包";
        $tree['button'][2]['sub_button'][0]['type'] = "view";
        $tree['button'][2]['sub_button'][0]['name'] = "红包飞飞飞";
        $tree['button'][2]['sub_button'][0]['url'] = "http://ks.sojump.hk/jq/9099241.aspx";
        $tree['button'][2]['sub_button'][1]['type'] = "view";
        $tree['button'][2]['sub_button'][1]['name'] = "客户中心";
        $tree['button'][2]['sub_button'][1]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-customerCenter&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][2]['sub_button'][2]['type'] = "view";
        $tree['button'][2]['sub_button'][2]['name'] = "母婴问答";
        $tree['button'][2]['sub_button'][2]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-motherBabyQA&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        $tree['button'][2]['sub_button'][3]['type'] = "view";
        $tree['button'][2]['sub_button'][3]['name'] = "育儿资讯";
        $tree['button'][2]['sub_button'][3]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-parentingInformation&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
        //$tree['button'][2]['url'] = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".APPID."&redirect_uri=".DOMAIN."Homemaking-index-t-mamabang&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
