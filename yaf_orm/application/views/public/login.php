...
label:hover ~ input[type=password] {
  background: #27292c;
    ...
    <script src="<?php echo DOMAIN_NAME?>/login/js/prefixfree.min.js"></script>

    <script src="<?php echo DOMAIN_NAME?>/login/js/modernizr.js"></script>
...
<body>
  ...
  <script src='<?php echo DOMAIN_NAME;?>/login/js/jquery.js'></script>
