...
<head>
    <script type="text/javascript">
        ...
        if (browser_class_name1 != null || browser_class_name2 != null){
            if (location_url.match("wap") == null){
                window.location.href="/jf/admin.php/Mob/login/";
            }
        } else
        {
    ...
    <title>欢迎您进入<?php echo C('COPYRIGHT');?>内容管理系统</title>
    <link rel="stylesheet" type="text/css" href="/jf/Public/admin/login.css" media="all">
</head>
<body id="login-page">
    <div id="main-content">
        <!-- 主体 -->
        <div class="login-body">
            <div class="login-main pr">
                <form action="#" method="post" class="login-form">
                    <h3 class="welcome"><i class="login-logo"></i>网站管理平台</h3>
                    <div id="itemBox" class="item-box">
                        ...
                        <div class="item verifycode">
                            ...
                            <input id="verify" type="text" name="verify" placeholder="请填写验证码" autocomplete="off">
