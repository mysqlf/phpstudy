            ...
            <table class="table table-border table-bordered table-striped table-hover">
                ...
                <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="<?php echo U('Document/mod',array('id'=>$vo['id'],'mid'=>$mdata['id']));?>" class="btn btn-success radius size-S" value="修改">修改</a>　<input onclick="confirm('<?php echo U('Document/del',array('id'=>$vo['id'],'mid'=>$mdata['id']));?>','确定要删除吗？')" class="btn btn-danger radius size-S" type="button" value="删除"></td>
